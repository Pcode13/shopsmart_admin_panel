...
import 'package:shopsmart_admin_panel/models/dashboard_btn_model.dart';
import 'package:shopsmart_admin_panel/widgets/dashboard_btns.dart';
      ...
      body: GridView.count(
        ...
        children: List.generate(
          ...
          (index) => DashboardButtonsWidget(
            ...
            imagePath:
                DashboardButtonsModel.dashboardBtnList(
                  context,
                )[index].imagePath,
            onPressed:
                DashboardButtonsModel.dashboardBtnList(
